...
func TestNew(t *testing.T) {
	...
	c.Gitlab.MaximumRequestsPerSecond = 5
	...
	c.Pull.RunnersFromProjects.OnInit = true
	c.Pull.RunnersFromProjects.Scheduled = true
	c.Pull.RunnersFromProjects.IntervalSeconds = 1800
	...
	c.GarbageCollect.Runners.Scheduled = true
	c.GarbageCollect.Runners.IntervalSeconds = 14400
	...
	c.ProjectDefaults.Pull.Refs.MergeRequests.Regexp = `.*`
