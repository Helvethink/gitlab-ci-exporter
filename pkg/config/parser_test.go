...
gitlab:
  ...
  token: xrN14n9-ywvAFxdwadadadadwadadw
...
`
	...
	xcfg.Redis.URL = "redis://some_adresse:1337"
	...
	xcfg.ProjectDefaults.Pull.Runners.Enabled = true
	xcfg.ProjectDefaults.Pull.Runners.Regexp = `.*`
	xcfg.ProjectDefaults.Pull.Runners.ExcludeStopped = false
